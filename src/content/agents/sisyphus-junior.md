...
description: Lightweight executor for simple tasks. Default model is Claude Sonnet 4.6 with a fallback chain through Kimi K2.6, GPT-5.5 medium, and MiniMax M2.7. Cannot re-delegate — prevents infinite loops. Used for category-routed work where full Sisyphus orchestration is overkill.
